...
function Signup() {
  ...
  return (
    ...
    <Row className="ms-5 mb-5">
        ...
        <Form.Control className="form3" type="text" placeholder="   Name" />
      </Form.Group>
    ...
    <h6 className="text-center mt-5 " style={{opacity:'0.8'}}> Already member?  <span><Link to={'/login'} style={{color:'#e5322d'}} className="fw-bold">Log in</Link> </span></h6>
    <p style={{fontSize:'15px'}} className="mt-2 text-center">By creating an account, you agree to iLovePDF<span style={{color:'#e5322d'}}>Terms of Service</span> and <span style={{color:'#e5322d'}}>Privacy Policy</span> </p>
        ...
        <h3 className="ms-5">PDF tools for productive people</h3>
        <h6 className="px-5 pt-1" style={{opacity:'0.6'}}>iLovePDF helps you convert, edit, e-sign, and protect PDF files quickly and easily. Enjoy a full suite of tools to effectively manage documents —no matter where you’re working.</h6>
        </div>
