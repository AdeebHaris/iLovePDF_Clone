  ...
  return (
    <>
      ...
      <div className=" row mt-5 ms-5 ps-4">
        ...
        <div className=" col-sm-12 col-lg-3 col-md-6 card d-flex flex-column border shadow-lg px-3 pt-5 pb-5 " style={{width:'270px'}}>
          ...
          <h5 className="mt-3" style={{color:'black'}}>Merge PDF</h5>
          <h6 className=" text-secondary mt-2" style={{ opacity: "0.6" }}>
        ...
        <div className="col-sm-12 col-lg-3 col-md-6 d-flex flex-column border shadow-lg px-3 pt-5 pb-5 ms-1 " style={{width:'270px'}}>
          ...
          <h5 className=" mt-3" style={{color:'black'}}>Split PDF</h5>
          <h6 className=" text-secondary mt-2" style={{ opacity: "0.6" }}>
            Sepereate one page or a whole set for easy conversion into
            ing=dependent PDF files
          </h6>
          </Link>
          
        </div>
        <div className="col-sm-12 col-lg-3 col-md-6 d-flex flex-column border shadow-lg px-3 py-5 ms-1 " style={{width:'270px'}}>
          <Link to={'/compress'} style={{textDecoration:'none'}}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="48"
            height="48"
          ...
          <h5 className=" mt-3" style={{color:'black'}}>Compress PDF</h5>
          <h6 className=" text-secondary mt-2" style={{ opacity: "0.6" }}>
        ...
        <div className="col-sm-12 col-lg-3 col-md-6 d-flex flex-column border shadow-lg px-3 py-5 ms-1 " style={{width:'270px'}}>
          ...
          <h5 className=" mt-3">PDF to Word</h5>
          <h6 className=" text-secondary mt-2" style={{ opacity: "0.6" }}>
        ...
        <div className="col-sm-12 col-lg-3 col-md-6 d-flex flex-column border shadow-lg px-3 py-5 ms-1 " style={{width:'270px'}}>
          ...
          <h5 className=" mt-3">Excel to PDF</h5>
          <h6 className=" text-secondary mt-2" style={{ opacity: "0.6" }}>
      ...
      <div className="row mt-1 ms-5 ps-4">
        <div className=" col-lg-3 col-lg-3 col-md-6 d-flex flex-column border shadow-lg px-3 py-5  " style={{width:'270px'}}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="48"
            height="48"
          ...
          <h5 className=" mt-3">PDF to Powerpoint</h5>
          <h6 className=" text-secondary mt-2 " style={{ opacity: "0.6" }}>
            Turn your PDF files into easy to edit PPT and PPTX slideshows.
          </h6>
        </div>
        <div className=" col-lg-3 col-lg-3 col-md-6 d-flex flex-column border shadow-lg px-3 py-5 ms-1 " style={{width:'270px'}}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="48"
            height="48"
          ...
          <h5 className=" mt-3">PDF to Excel</h5>
          <h6 className=" text-secondary mt-2" style={{ opacity: "0.6" }}>
            Pull data straight from PDFs into Excel spreadsheets in a few short
            seconds.
          </h6>
        </div>
        <div className=" col-lg-3 col-lg-3 col-md-6 d-flex flex-column border shadow-lg px-3 py-5 ms-1 " style={{width:'270px'}}>
          ...
          <h5 className=" mt-3">Word to PDF</h5>
          <h6 className=" text-secondary mt-2" style={{ opacity: "0.6" }}>
        ...
        <div className=" col-lg-3 col-lg-3 col-md-6 d-flex flex-column border shadow-lg px-3 py-5 ms-1 " style={{width:'270px'}}>
          ...
          <h5 className=" mt-3">Powerpoint to PDF</h5>
          <h6 className=" text-secondary mt-2" style={{ opacity: "0.6" }}>
        ...
        <div className=" col-lg-3 col-lg-3 col-md-6 d-flex flex-column border shadow-lg px-3 py-5 ms-1 " style={{width:'270px'}}>
          ...
          <h5 className=" mt-3">JPG to PDF</h5>
          <h6 className=" text-secondary mt-2" style={{ opacity: "0.6" }}>
      ...
      <div style={{ marginTop: "150px" }}>
        ...
        <Row className="ms-4  p-5">
          <Col sm={12} md={8} lg={4} xl={4} className="p-5">
            <h3>iLovePDF Desktop</h3>
            <p className="text-secondary ">
              Download the <Link className="text-danger">iLovePDF Desktop </Link>
               App to work with your favorite PDF tools on your Mac or Windows
              PC. Get a lightweight PDF app that helps you process heavy PDF
          ...
          <Col sm={12} md={8} lg={4} xl={4} className="p-5">
            ...
            <p className="text-secondary">
              Get the <Link className="text-danger">iLovePDF Mobile </Link> App to
              manage documents remotely or on the move. Turn your Android or
          ...
          <Col sm={12} md={8} lg={4} xl={4} className="p-5">
            <h3>iLoveIMG</h3>
            <p className="text-secondary">
              <Link className="text-danger">iLoveIMG </Link> is the web app that
              helps you modify images in bulk for free. Crop, resize, compress,
              convert, and more. All the tools you need to enhance your images
      ...
      <div style={{ marginTop: "200px" }}>
        <h1 className="text-center mb-3" style={{ fontSize: "40px" }}>
          The PDF software trusted by millions of users
        </h1>
        <h4 className="container text-center px-5 text-secondary ">
      ...
      <Row>
        ...
        <Col
          xl={6}
          lg={6}
          className="d-flex justify-content-evenly align-items-center p-5"
        >
          <img
            className="ms-4"
            width="55"
      ...
      <div className="premium p-5">
        <Row className="row p-5 d-flex justify-content-between">
          <Col lg={8} xl={7} sm={6} className="col1">
            <h1 className="text-light " >Get more with Premium</h1>
            ...
            <button id='button'
              className="btn  mt-5 px-4 py-2 fw-bold rounded-3"
            >
              Get Premium
            </button>
          </Col>
          <Col lg={4} xl={4} sm={6} className="col2">
            <svg
              width="365"
              height="269"
              fill="none"
            ...
            >
              ...
              <path
                fill="#FF6A58"
                d="M108 232.535 144.51 222l6.654 23.06-36.51 10.534z"
              ></path>
              <path
              ...
              ></path>
              <path
                d="m134.181 239.046.248.898-7.908 2.834a.558.558 0 0 0-.226.156l-.272-.968 8.158-2.92Z"
                fill="#FF6A58"
              ></path>
              <path
              ...
              ></path>
              <path
                d="m130.538 229.14.862.609-.629.226-1.833.656 1.833-.656-.233-.835Z"
                fill="#fff"
              ></path>
              <path
              ...
              ></path>
              <path
                d="m128.378 255.596-7.085.976c-.124.015-.249.031-.373.031l7.085-.976c.124 0 .249-.016.373-.031Z"
                fill="#BD060A"
              ></path>
              <path
              ...
              <path
                ...
                fill="#fff"
              ></path>
              <path d="M127.848 251.513Z" fill="#9999A2"></path>
              <path
              ...
              ></path>
              <path
                d="m170.657 39.497-1.227 5.192.357-9.688 1.227-5.191-.357 9.687Z"
                fill="#E5322D"
              ></path>
              <path
              ...
              ></path>
              <path
                d="m291.744 39.115 27.773 7.284"
                stroke="url(#d)"
                stroke-width="2"
                stroke-miterlimit="10"
                stroke-linecap="round"
              ...
              <defs>
                ...
                >
                  ...
                  <stop offset=".53" stop-color="#FCEE21"></stop>
                ...
                <linearGradient
                  ...
                  gradientUnits="userSpaceOnUse"
                >
                  <stop stop-color="#9CF"></stop>
                  <stop offset=".351" stop-color="#0062C5"></stop>
                  <stop offset=".691" stop-color="#9CF"></stop>
                  <stop offset="1" stop-color="#0062C5"></stop>
                </linearGradient>
                <filter
                  id="a"
                  x="0"
                ...
                >
                  ...
                  <feBlend
                    ...
                    result="effect1_dropShadow_811_12387"
                  ></feBlend>
                  <feBlend
                    in="SourceGraphic"
                    in2="effect1_dropShadow_811_12387"
                    result="shape"
                  ></feBlend>
                </filter>
                <filter
                ...
                >
                  ...
                  <feOffset dy="5"></feOffset>
                  <feGaussianBlur stdDeviation="7.5"></feGaussianBlur>
                  <feColorMatrix values="0 0 0 0 0.0862745 0 0 0 0 0.0862745 0 0 0 0 0.0862745 0 0 0 0.1 0"></feColorMatrix>
                  <feBlend
                    in2="BackgroundImageFix"
                    result="effect1_dropShadow_811_12387"
                  ></feBlend>
    ...
    <div className='container d-flex justify-content-evenly align-items-center mt-4'>
      <div className='d-flex flex-column'>
        <h6 className='text-danger'>ILOVEPDF</h6>
        <Link className='footer-link mb-2' to={'/'} >Home</Link>
        <Link className='footer-link mb-2' >Pricing</Link>
        <Link className='footer-link mb-2 ' >Security</Link>
        <Link className='footer-link mb-2' >Tools</Link>
        <Link className='footer-link' >FAQ</Link>
      </div>
      <div className='d-flex flex-column'>
        <h6 className='text-danger'>PRODUCT</h6>
        <Link className='footer-link mb-2'  >iLovePDF Desktop</Link>
        <Link className='footer-link mb-2' >iLovePDF Mobile</Link>
        <Link className='footer-link mb-2' >Developers</Link>
        <Link className='footer-link mb-2' >Features</Link>
        <Link className='footer-link '>iloveimg.com</Link>
      </div>
      <div className='d-flex flex-column mb-5'>
        <h6 className='text-danger'>SOLUTIONS</h6>
        <Link className='footer-link mb-2'  >Business</Link>
        <Link  className='footer-link mb-5' >Education</Link>
       
      </div>
      <div className='d-flex flex-column'>
        <h6 className='text-danger'>COMPANY</h6>
        <Link className='footer-link mb-2'  >Our Story</Link>
        <Link className='footer-link mb-2' >Blog</Link>
        <Link className='footer-link mb-2' >Press</Link>
        <Link className='footer-link mb-2' >Legal & Privacy</Link>
    ...
    <Row className='mb-4'>
      ...
      <div className=' d-flex flex-row-reverse mt-4 me-5 '>
          <img src="	https://www.ilovepdf.com/img/logos/google_play.svg" alt="" />
          <img className='me-3' src="	https://www.ilovepdf.com/img/logos/app_store.svg" alt="" />
      </div>
      </Col>
    </Row>
    </>
